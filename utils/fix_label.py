...
def fix_general_label_error(labels, type, slots,domain=None):

    label_dict = dict([ (l[0], l[1]) for l in labels]) if type else dict([ (str(domain).lower()+'-'+str(l), labels[l][0]) for l in labels.keys()]) 
